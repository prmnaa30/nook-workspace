<template>
	<UContextMenu :items="menuItems" :ui="{ content: 'min-w-44' }">
		<div
			...
			:class="
				isSelected
					? 'bg-blue-600/10 border-blue-500/40 text-blue-600 dark:text-blue-400 shadow-xs'
		...
		>
			...
			<div class="flex items-center gap-1">
				<UButton
					...
					:class="workspace.is_favorite ? 'text-amber-400 fill-amber-400 hover:text-amber-500' : 'text-neutral-500 opacity-0 group-hover:opacity-100'"
