<template>
  <UPopover v-model:open="isOpen" :content="{ align: 'start', side: popoverSide || 'top', sideOffset: 8 }">
    <div class="flex items-center gap-1">
      ...
      >
        <div class="flex items-center gap-2 truncate">
          <UIcon name="i-ph-calendar-blank-bold" class="size-4 text-blue-500 shrink-0" />
          <span class="truncate">{{ formattedDisplayLabel }}</span>
        </div>
        <UIcon name="i-ph-caret-down" class="size-3.5 opacity-50 shrink-0" />
      </UButton>
          ...
          <div class="pl-4 flex flex-col justify-between w-36 shrink-0">
            ...
            <div class="flex items-center justify-between pb-2 border-b border-neutral-200 dark:border-neutral-800 mb-2">
              <div class="flex items-center gap-1.5 text-xs font-semibold text-neutral-700 dark:text-neutral-300">
                <UIcon name="i-ph-clock-bold" class="size-4 text-blue-500" />
                <span>Time</span>
              </div>
...
// Opsi Jam (00 - 23) & Menit (00 - 55, kelipatan 5)
