...
export type TimelineViewMode = "list" | "calendar";

defineProps<{
	modelValue: TimelineViewMode;
}>();

const emit = defineEmits<{
	(e: "update:modelValue", mode: TimelineViewMode): void;
}>();

function selectView(mode: TimelineViewMode) {
