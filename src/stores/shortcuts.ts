...
import { addShortcut, deleteShortcut, getShortcuts, type Shortcut } from "../services/shortcuts";
import { ref } from "vue";
...
export const useShortcutStore = defineStore('shortcut', () => {
  ...
  async function createShortcut(workspaceId: number, title: string, type: 'web' | 'folder' | 'file', path: string, browserPath: string | null) {
